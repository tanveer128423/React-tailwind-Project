...
const Customer = () => {
  return (
    <div className="mb-230">
      <h1 className="text-5xl ml-25 mb-20">
        Customer <span className="text-green-900">Reviews</span>
      </h1>

      {/* -------------------------------------------- customer 1 ------------------------------------------- */}
      <div className="absolute w-140 h-65 border-green-800 border-3 ml-20 rounded-3xl">
        ...
        <div className="w-120 h-0.5 ml-12 mt-4 bg-gray-300 mt-2"></div>
        <p className="ml-13 mt-4 text-gray-600 text-xl">
      ...
      {/* ----------------------------------------------------customer 2--------------------------------------------------------------- */}
      <div className="absolute w-140 h-65 border-green-800 border-3 ml-180 rounded-3xl">
        <p className="absolute mt-5 ml-27 text-2xl text-gray-600">
      ...
      {/* -------------------------------------customer 3----------------------------------------------- */}
      <div className="absolute w-140 h-70 border-green-800 border-3 ml-180 mt-90 rounded-3xl">
        <p className="absolute mt-5 ml-27 text-2xl text-gray-600">
          Aisha <span className="text-green-900">Khan</span>
        </p>
        <img src={customer3} alt="customer" className="w-12 mt-3 ml-12" />
        <div className="w-120 h-0.5 ml-12 mt-4 bg-gray-300 mt-2"></div>
        <p className="ml-11 mt-6 mr-2 text-gray-600 text-xl">
      ...
      {/* -------------------------------------  customer 4 ----------------------------------------------  */}
      <div className="absolute w-140 h-70 border-green-800 border-3 ml-20 mt-90 rounded-3xl">
        <p className="absolute mt-5 ml-27 text-2xl text-gray-600">
          Michael <span className="text-green-900">Rossi</span>
        </p>
        <img src={customer4} alt="customer" className="w-12 mt-3 ml-12" />
        <div className="w-120 h-0.5 ml-12 mt-4 bg-gray-300 mt-2"></div>
        <p className="ml-12 mt-5 text-gray-600 text-xl">
